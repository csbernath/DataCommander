...
namespace Foundation.Data.SqlClient.PTypes;
    ...
    /// Base types for calling Microsoft SQL Server
    /// <para>A PType (<see cref="PInt32"/>,<see cref="PString"/> etc.) has 4 states:
    /// <list type="table">
    /// <item><term><c>Base</c></term><description>a concrete value</description></item>
    ...
    /// </para>
    /// <para>
    /// A stored procedure input parameter can be: <c>Base, Null, Default</c>
    /// </para>
    /// <para>
    /// A stored procedure output parameter can be: <c>Base, Null, Default</c>
    /// </para>
    /// <para>
    ///Returned value of stored procedure/function can be: <c>Base,Null,Empty</c>
    /// </para>
    /// </summary>
