...
{
    public static readonly double TicksPerNanosecond = Stopwatch.Frequency / (double) PowersOfTen.Power9;
    public static readonly double TicksPerMicrosecond = Stopwatch.Frequency / (double) PowersOfTen.Power6;
    public static readonly double TicksPerMillisecond = Stopwatch.Frequency / (double) PowersOfTen.Power3;
    ...
    public static readonly double NanosecondsPerTick = (double) PowersOfTen.Power9 / Stopwatch.Frequency;
    public static readonly double TimeSpanTicksPerStopwatchTick = (double) TimeSpan.TicksPerSecond / Stopwatch.Frequency;
    public static readonly double MicrosecondsPerTick = (double) PowersOfTen.Power6 / Stopwatch.Frequency;
    public static readonly double MillisecondsPerTick = (double) PowersOfTen.Power3 / Stopwatch.Frequency;
