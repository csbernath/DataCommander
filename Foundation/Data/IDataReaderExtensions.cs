...
{
    extension(IDataReader dataReader)
    {
        public ReadOnlySegmentLinkedList<T> ReadResult<T>(int segmentLength, Func<IDataRecord, T> readRecord)
        {
        ...
        public ReadOnlySegmentLinkedList<T> ReadNextResult<T>(int segmentLength, Func<IDataRecord, T> readRecord)
        {
        ...
        public T ReadScalar<T>(Func<IDataRecord, T> readScalar)
        {
        ...
        public T ReadNextScalar<T>(Func<IDataRecord, T> readScalar)
        {
            var nextResult = dataReader.NextResult();
            Assert.IsTrue(nextResult);
